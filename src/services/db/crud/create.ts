...
): Promise<QueryResult<T["create"], E>> => base(model, () => (model.create as Function)({ data, ...options }), options);
...
): Promise<QueryResult<T["createMany"], E>> => base(model, () => (model.createMany as Function)({ data, ...options }), options);
...
): Promise<QueryResult<T["createManyAndReturn"], E>> => base(model, () => (model.createManyAndReturn as Function)({ data, ...options }), options);
